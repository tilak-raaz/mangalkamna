export const departmentsData = [
  ...
  },
  {
    ...
    iconName: "Droplet",
    intro:
      "The Nephrology Department delivers comprehensive kidney care, from early diagnosis to advanced renal replacement therapy. Strict infection control and dialysis quality protocols are maintained.",
    conditions: [
  ...
  },
  {
    ...
    intro:
      "Our General Surgery Department handles a wide range of surgical procedures with meticulous care, advanced equipment, and experienced surgical teams.",
    conditions: [
  ...
  },
  {
    ...
    iconName: "Stethoscope",
    intro:
      "Comprehensive internal medicine services for diagnosis and management of acute and chronic diseases.",
    conditions: [
      "Diabetes",
      "Hypertension",
  ...
  },
  {
    ...
    isVisible: false,
    intro:
      "The Department of Cardiology focuses on early detection, intervention, and long-term management of heart diseases.",
    conditions: [
      "Heart Failure",
  ...
  },
  {
    ...
    isVisible: false,
    intro:
      "Our cardiac surgery unit provides advanced surgical care supported by a dedicated cardiac ICU.",
    conditions: [
  ...
  },
  {
    slug: "pathology",
    name: "Pathology",
    iconName: "Microscope2",
    intro:
      "Our Pathology Department provides comprehensive diagnostic services with NABL accreditation.",
    conditions: [
      "Clinical Pathology",
      "Histopathology",
      "Microbiology",
  ...
  },
  {
    ...
    iconName: "Zap",
    intro:
      "Advanced imaging facility with latest diagnostic equipment for precise medical imaging and diagnosis.",
    conditions: [
  ...
  },
  {
    ...
    iconName: "Stethoscope",
    intro:
      "Our ICU and HDU units are equipped with advanced ventilators, multiparameter monitors, central monitoring systems, infusion pumps, defibrillators, and isolation facilities.",
    conditions: [
