...
export default function ContactHero({ page }: { page?: PageRecord | null }) {
  const title = page?.title || "Contact Us";
  const description =
    page?.excerpt ||
    "Have questions? Need to find a specialist? Want to book an appointment? Reach out to us through any of the channels below.";
