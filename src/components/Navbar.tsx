...
export default function Navbar() {
  ...
  return (
    <nav className="fixed lg:absolute top-0 left-0 w-full z-50 py-4 lg:py-6 px-6 md:px-12 lg:px-24 bg-white/90 lg:bg-transparent backdrop-blur-md lg:backdrop-blur-none border-b border-slate-100 lg:border-none shadow-sm lg:shadow-none transition-all duration-300">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-4 lg:gap-6 relative z-[60]">
          ...
          <Link
            href="#appointment"
            className="hidden sm:inline-flex px-5 md:px-6 py-2.5 md:py-3 rounded-full bg-[#cb1b1a] text-white text-xs md:text-sm font-semibold hover:bg-[#681412] transition-colors shadow-lg shadow-[#cb1b1a]/30"
          >
            Book Appointment
          </Link>
      ...
      >
        <div className="flex flex-col gap-6 text-xl font-bold text-[#681412]">
          ...
          <div className="pt-2 flex flex-col gap-4 text-base font-semibold text-[#681412]/80">
            <Link href="#doctors" onClick={() => setIsMobileMenuOpen(false)}>
              Doctors & Team
            </Link>
            <Link
              href="#patient-info"
